# Generated by Django 2.1.4 on 2018-12-15 18:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sympathy_likee_account', to='service.Account')),
                ('liker', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sympathy_liker_account', to='service.Account')),
            ],
        ),
    ]
